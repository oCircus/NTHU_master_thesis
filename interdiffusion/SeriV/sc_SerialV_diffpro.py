...
class SCInterdiffusionSerialV:
    ...
    def save_data(
        ...
        dirname = f"test_sc_serial_dynamic_evolution_diffpro_data_size{parameter[-1]}_numofvacancy{parameter[-3]}_{parameter[1]}"
        # file_dir = r"/work1/u3284480/"
        dirpath = os.path.join(
            rf"E:\\Diffusion\interdiffusion\serialresult\0.02\scLattice", dirname
        )
